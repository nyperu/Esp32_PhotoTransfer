...
class TomatoDetector:
    ...
    def load_model(self, model_name):
        ...
        model = torch.hub.load('ultralytics/yolov5:v6.0', 'custom', path='C:/Users/Sez/.cache/torch/hub/checkpoints/hub/ultralytics_yolov5_v6.0/best.pt', force_reload=True).autoshape()
        return model
